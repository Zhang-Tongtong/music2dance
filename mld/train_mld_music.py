...
from model.mld_denoiser import DenoiserMLP, DenoiserTransformer  # 使用music版本
...
class Trainer:
    def __init__(self, args):
        ...
        if data_args.dataset == 'finedance':
            train_dataset = FineDanceDataset(
